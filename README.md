...
### 🏭 Industrial Capstone — LLM-as-a-Judge for Scalable Episodic Log Evaluation

> **Status:** Completed | **Repo:** Internal Private Repository *(Confidential — institutional NDA constraints apply)*

An industrial-purpose capstone initiative conducted in collaboration with a commercial service provider, centred on architecting a high-throughput evaluation framework for scalable episodic log streams generated by a live creative-writing platform. The engagement demanded robust modelling of behavioural trajectories extracted from episodic session data alongside rigorous assessment of AI-generated linguistic outputs at production scale.

**Engineering Scope:**
- Designed and orchestrated an **LLM-as-a-Judge evaluation pipeline** utilising Gemini 2.5 models, systematically assessing AI-generated sentence quality across 110 meticulously engineered test cases drawn from live industrial telemetry.
- Engineered a **prompt architecture** for evaluation rubric design, ensuring reproducible scoring across diverse narrative registers and episodic contexts with quantifiable inter-rater consistency.
- Developed **automated data-pipeline scaffolding** for ingesting and pre-processing high-throughput episodic log streams, enabling scalable batch inference whilst maintaining strict latency budgets.
- Conducted rigorous **LLM consistency analysis**, identifying systematic failure modes in AI-generated outputs under distributional shift across session types and user cohorts.

> ⚠️ **Confidentiality Notice:** The source code, proprietary datasets, internal evaluation benchmarks, and service-specific implementation details pertaining to this engagement are classified as **Confidential** under institutional and commercial NDA constraints. No repository link is available; technical artefacts remain in a private organisational archive.
